        ...
        [
            ...
            [
                ...
                <div key="story1116">
                    ...
                    phức tạp. Một học trò bối rối hỏi: {'"'}Thưa thầy, tại sao
                    dấu ngoặc này lại quan trọng đến vậy?{'"'} Frege trả lời rất
                    nghiêm túc: {'"'}Nếu không có nó, toàn bộ công trình sẽ sụp
                    đổ!{'"'}
                    <br />
                    <br />
            ...
            [
                <div key="story1119">
                    ...
                    nghe tin này, một người bạn của Hilbert nói: {'"'}Thật đáng
                    tiếc cho cậu ấy. Cậu ta sẽ chẳng làm được gì nhiều trong thơ
                    ca đâu{'"'}. Hilbert chỉ mỉm cười và nói: {'"'}Ồ, đừng lo.
                    Anh biết đấy, đối với thơ ca, nó chẳng sao cả nếu có ai đó
                    kém cỏi. Nhưng nếu một người kém cỏi trong toán học, cả thế
                    giới sẽ phải chịu đựng.{'"'}
                    <br />
                    <br />
                ...
                <div key="story1121">
                    ...
                    Hilbert chỉ mỉm cười và nói: {'"'}Vâng, tôi có thể là một
                    người chậm chạp khi học hỏi điều mới. Nhưng một khi tôi đã
                    hiểu được nó, tôi sẽ không bao giờ quên.{'"'}
                    <br />
                    <br />
            ...
            [
                <div key="story1124">
                    ...
                    tối giản (<InlineMath math="a, b" /> không có ước chung lớn
                    hơn 1), thì khi đó <InlineMath math="a^2 = 2b^2" />, suy ra
                    a phải là số chẵn. Khi đó <InlineMath math="2b^2" /> chia
                    hết cho 4 nên b^2 chia hết cho 2, lại suy ra b là số chẵn.
                    Vậy <InlineMath math="a, b" /> có ước chung là 2. (Mâu
                    thuẫn.)
                    <br />
                    <br />
