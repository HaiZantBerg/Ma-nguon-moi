...
export const quizExplaination = [
    [
        [
            <React.Fragment key="explaination1">
                <p>
                    d<br />d<br />d<br />d<br />
                </p>
            </React.Fragment>,
            <React.Fragment key="explaination2"></React.Fragment>,
            <React.Fragment key="explaination3"></React.Fragment>,
            <React.Fragment key="explaination4"></React.Fragment>,
        ],
    ],
    [[]],
    [[]],
...
export const answerArray = [[[1, 0]]];

export const choicesArray = [
    [
        [
            [
                "asasdasdadsadadasdsadassa aaaaaaaaaaaaaaaaaaaaaasssss",
                "saa",
