    ...
    return (
        <div ref={scope}>
            ...
            >
                ...
                />
                <div
                    className="bg-white relative z-10 scale-100 max-w-[800px] w-full h-full max-h-[400px] overflow-y-hidden rounded-xl px-5 py-2 flex flex-col shadow-[inset_0_4px_8px_0_rgb(0_0_0_/_0.3)]"
                    id="dialog"
                >
                    <div className="overflow-y-auto h-full flex flex-col">
                        <div className="flex flex-col grow">
                            <div className="grid grid-cols-[1fr_auto] grid-rows-1 text-2xl font-semibold">
                                <div className="col-[1/-1] row-[1/-1] justify-self-center">
                                    {quizName}
                                </div>
                                <button
                                    className="col-[2/-1] row-[1/-1]"
                                    onClick={handleCloseCardDialog}
                                >
                                    <Image
                                        src={cross}
