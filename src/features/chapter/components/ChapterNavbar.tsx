...
export default function ChapterNavbar() {
    return (
        <div className="fixed top-0 left-0 w-full z-[100] h-[7rem] backdrop-blur-3xl backdrop-brightness-150 shadow-[0_0_20px_#d1d1d1] rounded-b-2xl flex justify-between items-center px-[2rem]">
