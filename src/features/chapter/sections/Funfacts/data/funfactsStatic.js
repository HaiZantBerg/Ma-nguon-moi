        ...
        [
            ...
            [
                <div key="story111">
                    ...
                    dạo vừa giảng giải cho học trò của mình. Ông thường dẫn học
                    trò đi qua các khu vườn, giảng bài về triết học, khoa học,
                    và các chủ đề học thuật khác trong lúc cả nhóm cùng đi bộ.
                    Vì thói quen giảng dạy này, trường học của ông tại Lyceum
                    được gọi là {'"'}Peripatetic School{'"'} - tức là {'"'}
                    Trường học của những người đi bộ.{'"'}
                    <br />
                    <br />
                    Có một câu chuyện vui kể rằng, một ngày nọ, khi một học trò
                    mới tham gia lớp học và không quen với cách dạy này, cậu ta
                    cố gắng ghi chép trong khi đi bộ theo Aristotle. Sau một
                    thời gian dài cố gắng ghi chép mọi thứ, cậu ta bối rối và
                    hỏi: {'"'}Thưa thầy, chúng ta sẽ dừng lại để tôi viết bài
                    chứ?{'"'}
                    Aristotle nhìn học trò mới với nụ cười: {'"'}Hãy để suy nghĩ
                ...
                <div key="story114">
                    ...
                    quan trọng hơn là việc phải chọn xem chúng ta sẽ ăn gì tối
                    nay.{'"'}
                    Dĩ nhiên, câu trả lời này không khiến Pythias hài lòng, và
                ...
                <div key="story115">
                    ...
                    thế giới ý niệm{'"'} - cho rằng mọi sự vật trong thế giới
                    ...
                    rằng: {'"'}
                    Nếu thế giới ý niệm hoàn hảo đến thế, thì tại sao chúng ta
                    không thể nhìn thấy một con ngựa lý tưởng hoặc một cái bánh
                    lý tưởng ngoài đời thực?{'"'} Câu nói đùa này thể hiện cách
                    tiếp cận thực tế của Aristotle và cũng cho thấy ông không
                    ngại thách thức thầy mình, ngay cả khi nó mang tính hài
                    hước.
                </div>,
                <div key="story116">
            ...
            [
                <div key="story117">
                    ...
                    cách bình thản: {'"'}
                    Con chỉ đang làm điều đơn giản nhất, như lưỡi dao của chính
                    mình đã dạy con.{'"'}
                </div>,
                <div key="story118">
                ...
                <div key="story1111">
                    ...
                    nhân lên các giả thiết nếu không cần thiết. Tuy nhiên, có
                    một câu chuyện vui kể rằng, sự đơn giản của ông đôi khi còn
                    khiến các đồng nghiệp bất ngờ.
                    <br />
                    <br />
            ...
            [
                <div key="story1112">
                    ...
                    tiết đột ngột trở nên rất xấu, vợ của Boole khuyên ông không
                    nên ra ngoài vì mưa gió. Nhưng Boole, với tinh thần khoa học
                    và toán học, khẳng định rằng: {'"'}Một chút mưa không thể
                    gây hại cho người có lý trí.{'"'}
                    <br />
                    <br />
                    Kết quả là Boole đi bộ trong mưa suốt vài giờ, và ông bị cảm
                    nặng. Điều này khiến vợ ông bối rối, và bà đã cố gắng chữa
                    trị cho ông theo cách mà bà nghĩ phù hợp với tư duy logic
                    của Boole: bà đắp chăn ướt lên người ông, cho rằng nếu ông
                    bị cảm vì nước mưa, thì nước cũng sẽ chữa khỏi cho ông! Câu
                ...
                <div key="story1113">
                    ...
                    hỏi: {'"'}Anh có thể sử dụng logic để giải thích tại sao
                    chúng ta ăn bánh mì không?{'"'}
                    <br />
                    <br />
                    Boole đáp lại: {'"'}Chắc chắn rồi. Logic cho tôi biết rằng
                    nếu tôi không ăn, tôi sẽ cảm thấy đói. Nếu tôi đói, tôi sẽ
                    không thể làm việc hiệu quả. Nếu tôi không làm việc hiệu
                    quả, tôi sẽ không thể nghiên cứu logic. Vì vậy, logic khẳng
                    định tôi phải ăn bánh mì để tiếp tục suy nghĩ về logic.{'"'}
                    <br />
                    <br />
                    Câu trả lời của Boole khiến người bạn bật cười, bởi nó cho
                ...
                <div key="story1114">
                    ...
                    hước là Mary từng than phiền rằng cuộc sống với một nhà
                    logic học như Boole đôi khi giống như sống trong một bài
                    toán!
                    <br />
                    <br />
                    Có lần, Mary hỏi Boole về việc nuôi dạy con cái, mong rằng
                    ông sẽ có những lời khuyên thực tế. Boole lại bắt đầu giải
                    thích bằng một chuỗi các suy luận logic phức tạp, mà Mary
                    phải ngắt lời: {'"'}George, chúng ta chỉ đang nói về bữa ăn
                    tối của lũ trẻ thôi mà, không phải một bài toán đại số!{'"'}
                    <br />
                    <br />
                    Những câu chuyện hài hước về George Boole không chỉ giúp
                    chúng ta thấy được tính cách thú vị của ông, mà còn cho thấy
                    cách ông sống với niềm đam mê toán học và logic trong từng
                    khoảnh khắc của cuộc đời. Dù có đôi khi Boole bị cuốn vào
                    những suy luận phức tạp, nhưng điều đó chỉ làm tăng thêm sự
                    đáng yêu và thú vị của một trong những người đã đặt nền móng
                    cho khoa học máy tính hiện đại.
                </div>,
            ],
            [
                <div key="story1115">
                    ...
                    để viết cuốn sách này, với mục tiêu xây dựng nền tảng logic
                    cho số học. Tuy nhiên, ngay sau khi Frege xuất bản cuốn
                    sách, nhà logic học Bertrand Russell đã phát hiện ra một
                    nghịch lý (được gọi là Nghịch lý Russell), làm lung lay toàn
                    bộ hệ thống của Frege.
                    <br />
                    <br />
                    Câu chuyện kể rằng, khi Frege nhận được bức thư từ Russell
                    giải thích về nghịch lý, Frege đã vô cùng bất ngờ. Thay vì
                    tức giận hay thất vọng, ông chỉ bình tĩnh ngồi xuống và viết
                    thêm một phụ lục vào cuốn sách, thừa nhận rằng phát hiện của
                    Russell đã phá vỡ nền tảng lý thuyết của mình. Frege viết
                    trong phần mở đầu của phụ lục với sự thẳng thắn và một chút
                    tự trào: {'"'}Một sự sụp đổ đã xảy ra trong tòa nhà logic
                    của tôi.{'"'}
                    <br />
                    <br />
                    Mặc dù đây là một cú sốc lớn cho công việc của Frege, nhưng
                    cách ông phản ứng với sự bình thản và đôi chút hài hước đã
                    khiến nhiều người nể phục. Frege không đổ lỗi cho ai, mà chỉ
                ...
                <div key="story1116">
                    ...
                    để giải thích một dấu ngoặc đơn trong một công thức logic
                    phức tạp. Một học trò bối rối hỏi: {'"'}
                    Thưa thầy, tại sao dấu ngoặc này lại quan trọng đến vậy?
                    {'"'} Frege trả lời rất nghiêm túc: {'"'}Nếu không có nó,
                    toàn bộ công trình sẽ sụp đổ!{'"'}
                    <br />
                    <br />
                    Lời nói của Frege khiến cả lớp bật cười vì sự chi tiết đến
                    mức tưởng như thái quá, nhưng sau đó các học trò nhận ra
                    rằng ông hoàn toàn đúng. Điều này không chỉ là một trò đùa,
                ...
                <div key="story1117">
                    ...
                    không phải là triết gia hay nhà toán học. Người bạn hỏi
                    Frege một câu hỏi rất đơn giản: {'"'}Anh nghĩ gì về thời
                    tiết hôm nay?{'"'}
                    <br />
                    <br />
                    Frege suy nghĩ một lúc lâu, rồi trả lời: {'"'}Tôi không thể
                    đưa ra một câu trả lời logic về điều này, vì các thông tin
                    về thời tiết hôm nay chưa đủ đầy đủ để xác minh.{'"'} Câu
                    trả lời của Frege khiến cả bàn tiệc bật cười, bởi ngay cả
                ...
                <div key="story1118">
                    ...
                    trị dinh dưỡng của từng loại bánh, rồi phân tích xem loại
                    nào là lựa chọn hợp lý hơn dựa trên một chuỗi các lý luận
                    logic phức tạp.
                    <br />
                    <br />
                    Cuối cùng, sau khi đứng phân vân gần cả giờ đồng hồ, ông
                    không thể đưa ra quyết định và rời khỏi siêu thị mà không
                    mua gì cả. Một người bạn biết chuyện đã đùa rằng: {'"'}Frege
                    có thể giải quyết những vấn đề logic phức tạp của thế giới,
            ...
            [
                <div key="story1119">
                    ...
                    một sinh viên từ bỏ toán học để theo học môn thơ ca. Khi
                    nghe tin này, một người bạn của Hilbert nói: {'"'}
                    Thật đáng tiếc cho cậu ấy. Cậu ta sẽ chẳng làm được gì nhiều
                    trong thơ ca đâu{'"'}. Hilbert chỉ mỉm cười và nói: {'"'}Ồ,
                    đừng lo. Anh biết đấy, đối với thơ ca, nó chẳng sao cả nếu
                    có ai đó kém cỏi. Nhưng nếu một người kém cỏi trong toán
                    học, cả thế giới sẽ phải chịu đựng.{'"'}
                    <br />
                    <br />
                    Câu nói này vừa thể hiện sự hài hước, vừa ngụ ý về tầm quan
                ...
                <div key="story1120">
                    ...
                    cứu tại trường, Hilbert được hỏi về lý do tại sao nhiều sinh
                    viên không muốn học toán. Ông đã trả lời đầy hài hước:
                    {'"'}Chúng ta sẽ chẳng bao giờ phải lo lắng về việc sinh
                    viên bỏ toán học đâu. Những người kém nhất rồi sẽ bỏ cuộc và
                    sẽ theo học các môn khác, chẳng hạn như triết học.{'"'}
                    <br />
                    <br />
                    Câu nói này vừa là một lời châm biếm nhẹ nhàng vừa phản ánh
                    niềm tin của Hilbert rằng toán học là một môn khoa học đòi
                ...
                <div key="story1121">
                    ...
                    Hilbert chỉ mỉm cười và nói: {'"'}
                    Vâng, tôi có thể là một người chậm chạp khi học hỏi điều
                    mới. Nhưng một khi tôi đã hiểu được nó, tôi sẽ không bao giờ
                    quên.{'"'}
                    <br />
                    <br />
                    Điều này thể hiện sự kiên trì và tự tin của Hilbert trong
                    quá trình nghiên cứu khoa học, và nó đã trở thành một trong
                ...
                <div key="story1122">
                    ...
                    như một lĩnh vực nghiên cứu do sự phát triển của các ngành
                    khoa học khác, Hilbert liền tuyên bố: {'"'}Đừng lo lắng.
                    Ngay cả khi hình học chết đi, chúng tôi sẽ đặt nó vào một
                    ngôi mộ trang trọng, và tôi sẽ đọc bài điếu văn cho nó.{'"'}
                    <br />
                    <br />
                    Thật ra, hình học không chỉ không {'"'}chết{'"'} mà còn phát
                    triển mạnh mẽ hơn nhờ những nghiên cứu của Hilbert và các
                    nhà toán học khác. Câu nói này vừa thể hiện tính cách hài
                ...
                <div key="story1123">
                    ...
                    tạp của sinh viên, Hilbert chỉ đặt một câu hỏi duy nhất:
                    {'"'}Vậy làm thế nào để nấu súp từ ý tưởng của anh?{'"'}
                    <br />
                    <br />
                    Mọi người trong phòng bật cười, vì Hilbert đã dùng sự hài
                    hước của mình để nhẹ nhàng chỉ ra rằng bài trình bày của
                    sinh viên quá lý thuyết và không có tính ứng dụng thực tiễn.
                    Dù là một nhà toán học thuần túy, Hilbert vẫn đánh giá cao
                    sự kết nối giữa lý thuyết và thực hành.
                </div>,
            ],
            [
                <div key="story1124">
                    ...
                    <br />
                    <br />
                    {'"'}Ngươi đã thề lời thề của những môn đồ Pythagoras. Và
                    ngươi đã phản bội lời thề đó, Hippasus{'"'}, thủ lĩnh của
                    đám đông tuyên bố.
                    <br />
                    <br />
                    {'"'}Tôi đã chứng minh một điều không thể tưởng tượng được:
                    sự tồn tại của các số vô tỉ. Các người muốn tôi giữ bí mật
                    điều này ư? Các người đang yêu cầu tôi che giấu tri thức và
                    sự thật{'"'}, Hippapus điềm tĩnh nói.
                    <br />
                    <br />
                    {'"'}Ngươi biết rằng chúng ta đã bảo đó không phải là những
                    con số rồi cơ mà{'"'}, viên thủ lĩnh đáp trả.
                    <br />
                    <br />
                    {'"'}Nhưng <InlineMath math="\sqrt{2}" /> là một con số!
                    Chẳng phải chức năng của số là để đo hay sao?{" "}
                    <InlineMath math="\sqrt{2}" /> dùng để đo một độ dài xác
                    định. Không có số nào khác biểu thị chính xác độ dài của
                    đường chéo một hình vuông có cạnh là 1{'"'}, Hippasus kiên
                    quyết bảo vệ ý mình.
                    <br />
                    <br />
                    Đám đông các môn đồ của Pythagoras trên boong tàu càng lúc
                    càng mất kiên nhẫn. Sự thật đã làm cho họ lo sợ. Bỗng nhiên,
                    những tiếng la hét của họ biến thành hành động. Mọi chuyện
                    xảy ra rất nhanh. Không ai trên tàu có thể ngăn cản sự kích
                    động của đám đông. {'"'}Ném hắn xuống biển{'"'}, họ la lên
                    khi tìm cách che giấu điều không thể che giấu được là{" "}
                    <InlineMath math="\sqrt{2}" /> = 1,41421... Họ tóm lấy
                    ...
                    <br />
                    <br />
                    Có thể đến đây bạn sẽ nghĩ rằng chỉ là vài con số thôi mà
                    tại sao họ lại phải hại nhau như vậy! Nhưng với những người
                    Hy Lạp cổ mà đặc biệt là những người theo {'"'}trường phái
                    Pythagoras{'"'}, toán học đóng vai trò đặc biệt trong cuộc
                    sống của họ. Đối với họ thì bản chất của vũ trụ là các con
                    số mà cụ thể là các số tự nhiên và tỉ số của chúng (phân
                    số). Số 1 là con số thần thánh sáng tạo nên tất cả các số.
                    Số 2 là số chẵn đầu tiên, được coi là thuộc nữ giới. Số 3 là
                    số thuộc nam giới và thể hiện sự điều hoà vì là tổng của 1
                    và 2, v.v... Họ tôn thờ các con số và cho rằng tất cả mọi số
                    trên đời đều là số tự nhiên hoặc là tỉ số của chúng (các
                    phân số). Nhưng rồi định lý Pythagoras nổi tiếng được ra đời
                    và hệ quả đi theo là những đại lượng {'"'}không phải số{'"'}
                    . Vậy bạn có thể hình dung các môn đồ của Pythagoras đã tức
                    giận như thế nào khi Hyppasus không giữ lời thề và tuyên bố
                    rằng có thể chứng minh <InlineMath math="\sqrt{2}" /> không
                    thể biểu diễn được dưới dạng tỉ số của hai số tự nhiên để
                    rồi quyết định {'"'}trừng phạt{'"'} ông một cách tàn bạo.
                    Nhưng rồi bí mật chẳng giữ được lâu, cuối cùng người ta đã
                    cùng công nhân rằng có những số {'"'}vô tỉ{'"'} (không thể
                    viết dưới dạng phân số của các số nguyên) và sử dụng nó cho
                    đến tận ngày nay. Ta có thể phỏng lại cách chứng minh của
                    Hyppasus theo ngôn ngữ hiện đại:
                    <br />
                    <br />
                    Giả sử <InlineMath math="\sqrt{2} = a/b" /> là một phân số
                    tối giản (
                    <InlineMath math="a, b" /> không có ước chung lớn hơn 1),
                    thì khi đó <InlineMath math="a^2 = 2b^2" />, suy ra a phải
                    là số chẵn. Khi đó <InlineMath math="2b^2" /> chia hết cho 4
                    nên b^2 chia hết cho 2, lại suy ra b là số chẵn. Vậy{" "}
                    <InlineMath math="a, b" /> có ước chung là 2. (Mâu thuẫn.)
                    <br />
                    <br />
                    Vậy là những số vô tỉ đầu tiên đã ra đời như vậy đấy. Mặc dù
                    Hyppasus đã bị hiểu nhầm và chết một cách oan uổng nhưng ông
                    đã đóng góp viên đá nền để con người có thể xây dựng trường
                    số thực mà ta vẫn quen dùng ngày nay. Các con số xuất hiện
                    trong tự nhiên như <InlineMath math="\pi" />,{" "}
                    <InlineMath math="e" />, và tỉ lệ vàng đều là các số vô tỉ!
                    <br />
                    <br />
