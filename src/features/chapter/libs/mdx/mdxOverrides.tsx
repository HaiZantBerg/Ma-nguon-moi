...
export const overrideComponents = {
    h1: (props: ComponentPropsWithoutRef<"h1">) => (
        <h1
            className="text-2xl sm:text-3xl min-[1000px]:text-4xl font-bold min-[1000px]:mb-[2rem] mb-[1rem]"
            {...props}
        />
    ),
    h2: (props: ComponentPropsWithoutRef<"h2">) => (
        <h2
            className="text-base sm:text-xl min-[1000px]:text-2xl font-bold min-[1000px]:mb-[2rem] mb-[1rem]"
            {...props}
        />
    ),
    ...
    ul: (props: ComponentPropsWithoutRef<"ul">) => (
        <ul className="min-[1000px]:mb-[2rem] mb-[1rem]" {...props} />
    ),
