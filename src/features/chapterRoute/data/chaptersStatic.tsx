    ...
    grade10: {
        ...
        description: [
            <div key="description1">
                <p className="mb-1.5">
                    <span className="font-bold">Mệnh đề</span> là một câu khẳng
                    định trong toán học có thể đúng hoặc sai. Nó thường được sử
                    dụng để phát biểu các kết luận trong lý thuyết. Mệnh đề có
                    thể có các dạng như mệnh đề đảo, mệnh đề tương đương, và
                    được chứng minh qua các phương pháp logic.
                </p>
                <p>
                    Lịch sử toán học về{" "}
                    <span className="font-bold">tập hợp</span> và các phép toán
                    trong tập hợp có thể được tóm tắt qua một số mốc quan trọng.
                    Tập hợp là một khái niệm cơ bản trong toán học, và sự phát
                    triển của lý thuyết tập hợp đã có ảnh hưởng sâu rộng đến các
                    lĩnh vực khác của toán học và khoa học máy tính.
                </p>
            </div>,
            ...
            >
                ...
                phải biết rõ các khái niệm chúng ta đang bàn đến có ý nghĩa thế
                nào về mặt từ ngữ. Từ “
                <span className="font-[475]">lượng giác</span>” được sử dụng
                trong các chương trình giáo dục của Việt Nam từ lúc bắt đầu có
                chương trình giáo dục phổ thông từ giữa thế kỷ XX. Đây là một từ
                Hán Việt ghép từ 2 khái niệm: “lượng” mang ý nghĩa về đo lường
                và “giác” nói về các góc, nên có thể hiểu “lượng giác” mang ý
                nghĩa là một phương pháp đo lường và định lượng về góc.
                <br />
                <br />
                Nếu chỉ mang ý nghĩa như trên chúng ta không có gì để bàn ở đây,
                trong tiếng Anh hoặc tiếng Pháp, khái niệm “lượng giác” được
                tương ứng với “<span className="font-[475]">trigonometry</span>
                ”, đây là một từ xuất phát từ tiếng Hy Lạp - nền văn minh đặt
                nền tảng cho sự phát triển của nền văn mình phương Tây - trong
                đó, “<span className="font-[475]">trigōnon</span>” có nghĩa là
                “tam giác” và “<span className="font-[475]">metron</span>” mang
                nghĩa “đo lường”. Như thế khái niệm “lượng giác” trong tiếng Anh
                lại có ý nghĩa là sự đo lường về góc bằng tam giác.{" "}
                <Link
                    target="_blank"
    ...
    grade11: {
        ...
        description: [
            <div key="description10">
                Lịch sử phát triển của lượng giác đi cùng với sự phát triển của
                đo đạc và thiên văn. Để hiểu rõ hơn bạn đọc có thể tìm hiểu thêm
                ở{" "}
                <Link
                ...
                <br />
                <br />
                Ở chương này, chúng ta sẽ đi cụ thể hơn về hàm số lượng giác,
                phương trình lượng giá. Và để có thể tìm hiểu về các khái niệm
                này, thì đầu tiên ta cùng nhau đi tìm hiểu về lịch sử phát triển
                của góc lượng giác và góc theo đơn vị radian.
                <br />
                <br />
