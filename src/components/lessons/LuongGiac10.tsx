        ...
        <>
            <div className="mt-[10px] h-fit">
                ...
                <div className={`${generalClassName}`}>
                    ...
                    <div className={`${generalContentClassName}`}>
                        ...
                        hoi.
                        <div className="lgmi:grid-cols-2 lgmi:grid-rows-[300px_auto] my-3 grid grid-cols-1 grid-rows-[300px_auto_300px_auto]">
                            <div className="lgmi:col-[1/2] lgmi:row-[1/2] row-[1/2] justify-self-center p-2">
                                <Image
                                    src={luongGiacImage1}
                                    alt=""
                            ...
                            <div className="lgmi:col-[2/-1] lgmi:row-[1/2] row-[3/4] justify-self-center p-2">
                                <Image
                                    src={luongGiacImage2}
                                    alt=""
                                    className="h-full w-auto"
                            ...
                            <div className="lgmi:col-[1/2] lgmi:row-[2/-1] lgmi:px-1 lgmi:pb-0 row-[2/3] px-5 pt-2 pb-5 text-center text-[rgba(0,0,0,0.75)]">
                            ...
                            <div className="lgmi:col-[2/-1] lgmi:row-[2/-1] lgmi:px-1 row-[4/-1] px-5 pt-2 text-center text-[rgba(0,0,0,0.75)]">
                        ...
                        >
                            <div>
                                <div className="lg3:flex-row flex flex-col">
                                    <div>
                                    ...
                                    <div className="lg3:flex-[1_0_30%] lg3:w-auto flex w-[70%] flex-none items-end md:w-[50%]">
                                        <Image
                                ...
                                <div className="mt-2 aspect-video max-w-[700px]">
                                    <ReactPlayer
                        ...
                        <ExtraInlineFact buttonContent="trắc địa bộ hành">
                            ...
                            <div className="lgmi:grid-cols-2 lgmi:grid-rows-[300px_auto] my-3 grid grid-cols-1 grid-rows-[300px_300px_auto]">
                                <div className="lgmi:col-[1/2] lgmi:row-[1/2] row-[1/2] justify-self-center p-2">
                                    <Image
                                ...
                                <div className="lgmi:col-[2/-1] lgmi:row-[1/2] row-[2/3] justify-self-center p-2">
                                    <Image
                                        src={luongGiacGieng}
                                        alt=""
                                        className="h-full w-auto"
                                ...
                                <div className="lgmi: lgmi:row-[2/-1] lgmi:px-1 lgmi:pb-0 px-5 pt-2 pb-5 text-center text-[rgba(255,255,255,0.75)]">
                    ...
                    <ExtraAloneFact buttonContent="Al-Biruni - Đường chân trời và bán kính của Trái đất">
                        ...
                        <br />
                        <br />
                        <div className="xxlg:flex-col flex flex-col gap-2 md:flex-row">
                            <div>
                            ...
                            <div className="my-2 max-w-[300px] min-w-[250px]">
                                <Image
                        ...
                        <div className="my-4 aspect-video max-w-[700px]">
                            <ReactPlayer
            ...
            <div className="mt-[10px] h-fit">
                ...
                <div className={`${generalClassName}`}>
                    ...
                    <div className="my-4 flex justify-center md:justify-normal">
                    ...
                    <div className={`${generalContentClassName}`}>
                        ...
                        tròn.
                        <div className="md1:w-fit mt-4 flex w-full flex-col items-center gap-4">
            ...
            <div className="mt-[10px] h-fit">
                ...
                <div className={`${generalClassName}`}>
                    ...
                    <div className={`${generalContentClassName}`}>
                        ...
                        <div className="mt-5 grid grid-cols-1 grid-rows-[repeat(5,auto)] justify-items-center text-center text-[rgba(0,0,0,0.75)] md:mt-2 md:grid-cols-2 md:grid-rows-[repeat(3,auto)]">
                            <div className="px-10 md:col-[1/2] md:row-[1/2]">
                                <div className="max-w-[200px] min-w-[125px] self-center md:max-w-[250px] md:min-w-[200px]">
                                    <Image
                                        src={Dioptra}
                                        alt=""
                                        className="h-auto w-full"
                            ...
                            <div className="m-2 md:col-[1/2] md:row-[2/3]">
                            ...
                            <div className="mt-5 flex min-h-[100px] items-end self-center md:col-[2/-1] md:row-[1/2] md:mt-0 md:items-center md:px-2">
                            ...
                            <div className="m-2 md:col-[2/-1] md:row-[2/3]">
                                Cách sử dụng Dioptra để đo góc khi quan sát
                                thiên văn
                            </div>
                            <div className="mt-5 flex flex-col items-center justify-center gap-2 md:col-[1/-1] md:row-[3/4] md:mt-0 md:px-40">
                                ...
                                >
                                    ...
                                    <div className="my-3 aspect-video max-w-[700px]">
                                        <ReactPlayer
                    ...
                    <ExtraAloneFact buttonContent="Aristarchus và Những Ước Tính Kinh Ngạc Về Vũ Trụ">
                        <div className="xxlg:flex-col flex flex-col items-center gap-2 md:flex-row md:items-start">
                            ...
                            <div className="xxlg:min-w-[500px] w-full max-w-[300px] md:min-w-[300px]">
                                <Image
