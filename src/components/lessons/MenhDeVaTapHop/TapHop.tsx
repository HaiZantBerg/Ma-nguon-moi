    ...
    return (
        <>
            <div className="mt-[10px] h-fit">
                ...
                <div
                    className={`${generalClassName} lg2:grid-cols-[auto_auto] lg2:grid-rows-[auto_auto] grid`}
                >
                    <div className="md1:text-[1.25rem] md1:leading-[1.325rem] col-[1/2] row-[1/2] mb-5 text-base font-semibold">
                        Người nguyên thủy đếm như thế nào?
                    </div>
                    <div
                        className="lg2:col-[1/2] lg2:row-[2/-1] md1:justify-normal flex cursor-pointer items-start justify-center"
                        onClick={() => handleStartVideo(0)}
                    >
                        <div className="lg2:sticky lg2:top-[20px] aspect-[304/207] w-full max-w-[400px]">
                            <ReactPlayer
                    ...
                    <div
                        className={`${generalContentClassName} lg2:col-[2/-1] lg2:row-[2/-1] lg2:pl-5 lg2:pt-0 md1:pr-5 pt-5`}
                    >
                ...
                <div className={`${generalClassName}`}>
                    <ExtraAloneFact buttonContent="Xương Ishango">
                        <div className="lg3:flex-row flex h-full w-full flex-col items-center gap-2 text-lg">
                            <div
                            ...
                            <div className="lg3:flex-[1_0_50%]">
                                <div className="aspect-[595/311] w-full">
                                    <Image
                                        src={Boner}
                                        alt=""
                ...
                <div className={`${generalClassName}`}>
                    ...
                    <div className={`${generalContentClassName}`}>
                        ...
                        tượng việc gắn tên {'"'}số
                        {'"'} cho một điều không tồn tại tạo nên một cuộc các
                        mạng thế nào. Vậy thì đối với số 0 lại càng khó khăn để
                        chấp nhận hơn.
                        <br />
                        ...
                        hề gặp {'"'}
                        số không{'"'} trong tự nhiên để nó có thể hữu hình, dễ
                        hiểu. Bất cứ số tự nhiên nào lớn hơn không đều có ví dụ
                        thực hiện: một con khỉ, hai con ong, ba trái đào hay bốn
                        bông hoa. Nhưng {'"'}không{'"'} thì sao? Phải có chút
                        nhận thức để nhận ra cái vô hình cũng là cái hữu hình,
                        trong hư có thực, {'"'}không có gì{'"'} cũng là một cái
                        gì đó.
                        <br />
                    ...
                    >
                        ...
                        <div className="my-2 h-[1px] w-full bg-[#327e0c]" />
                    </ExtraQuiz>
                    <div className={`${generalContentClassName}`}>
            ...
            <div className="h-fit">
                <div className="grid grid-cols-[20px_auto] grid-rows-1 md:grid-cols-[28.5px_auto]">
                    <div className="col-[1/2] row-[1/-1]">
                        {timelineStar.Star1dc19}
                    </div>
                    <div className="col-[2/-1] row-[1/-1] ml-3 flex flex-wrap">
                ...
                <div className={`${generalClassName}`}>
                    ...
                    <div className={`${generalContentClassName}`}>
                        ...
                        {'"'}Begriffsschrift
                        {'"'} (1879), Frege đã đưa ra một hệ thống logic đại số
                        để hình dung và mô tả các khái niệm toán học. Ông đã
                        phát triển phép tính tâm lý học (predicate calculus),
                        một nền tảng cơ bản của logic toán học hiện đại.
                        <br />
                        <br />
