            ...
            <div className="col-[1/-1] row-[1/2] mt-[10px] h-fit">
                ...
                <div className={`${generalClassName}`}>
                    ...
                    <div className={`${generalContentClassName}`}>
                        ...
                        Aristotle là khái niệm {'"'}sự phủ định
                        {'"'} của một mệnh đề. Ông phân loại mệnh đề thành {'"'}
                        đúng{'"'} hoặc
                        {' "'}sai{'"'}, và mỗi mệnh đề có thể được phủ định để
                        trở thành một mệnh đề ngược lại. Ví dụ: {'"'}Tất cả
                        người Hy Lạp là công dân tự do
                        {'"'} có thể bị phủ định thành {'"'}Không phải tất cả
                        người Hy Lạp là công dân tự do{'"'}. Mặc dù Aristotle
                        không sử dụng các ký hiệu toán học như chúng ta làm ngày
                        nay, nhưng lý thuyết của ông đã chi phối tư tưởng triết
                        học phương Tây suốt hơn 2000 năm. Các nguyên lý cơ bản
                        của ông về mệnh đề và suy luận vẫn là nền tảng cho lý
                        thuyết logic cho đến thời đại hiện đại.
                    </div>
                </div>
                <div className="col-[1/-1] row-[1/2] mt-[10px] h-fit">
                ...
                <div className="col-[1/-1] row-[1/2] mt-[10px] h-fit">
                    ...
                    <div className={`${generalClassName}`}>
                        ...
                        <div className={`${generalContentClassName}`}>
                            ...
                            là sinh vật
                            {'"'} có thể được biểu diễn bằng các phép toán đại
                            số như sau: Giả sử:
                            <br />
