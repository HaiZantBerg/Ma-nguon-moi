    ...
    return (
        <>
            <div className="col-[1/-1] row-[1/2] mt-[10px] h-fit">
                <div className="relative top-[-10px] left-[4px] z-[100] flex h-[40px] bg-white pt-2 font-['Algerian'] text-[32.5px] leading-[1] md:h-[55px] md:text-[45px]">
                    I.
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 165.5 24.35"
                        className="h-[120%] translate-x-3 -translate-y-1 md:-translate-y-2"
                    >
                        <path
            ...
            <div className="col-[1/-1] row-[4/5] mt-[10px] h-fit">
            ...
            <div className="col-[1/-1] row-[5/6] mt-[10px] h-fit">
                <div className="relative top-[-10px] left-[4px] z-[100] flex flex-wrap pt-2 font-['Algerian'] text-[32.5px] leading-[1] *:bg-white md:text-[45px]">
                    ...
                    <svg
                        ...
                        className="mr-3 h-[42px] -translate-y-[6px] md:h-[57px] md:-translate-y-2"
                    >
                        <polygon
                    ...
                    <svg
                        ...
                        className="h-[42px] -translate-y-[6px] md:h-[57px] md:-translate-y-2"
                    >
                        <path
                            d="M272.25,306.86a1.85,1.85,0,0,1,.3.87,1,1,0,0,1-.42.95,1.5,1.5,0,0,1-1.32.24,1.49,1.49,0,0,0,.88.18,1.06,1.06,0,0,0,1-1.21A1.47,1.47,0,0,0,272.25,306.86Z"
                ...
                <div className={`${generalClassName}`}>
                    <div className="md1:w-fit my-2 flex w-full flex-col items-center gap-4">
            ...
            <div className="col-[1/-1] row-[6/7] mt-[10px] h-fit">
            ...
            <div className="col-[1/-1] row-[7/8] mt-[10px] h-fit">
            ...
            <div className="col-[1/-1] row-[8/9] mt-[10px] h-fit">
